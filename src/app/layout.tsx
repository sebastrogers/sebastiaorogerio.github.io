      ...
      >
        <header className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-md border-b border-white/10">
          <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <ul className="hidden md:flex items-center space-x-8 text-sm font-medium">
              ...
              <li><a href="/experiencia" className="hover:text-cyan-400 transition duration-300">Experiência</a></li>
              <li><a href="/projetos" className="hover:text-cyan-400 transition duration-300">Projetos</a></li>
              <li><a href="/artigos" className="hover:text-cyan-400 transition duration-300">Artigos</a></li>
              <li><a href="/blog" className="hover:text-cyan-400 transition duration-300">Blog</a></li>
              <li><a href="/contato" className="hover:text-cyan-400 transition duration-300">Contato</a></li>
            </ul>
        ...
        <footer className="border-t border-white/10 bg-black/50 py-12">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-400">&copy; 2026 Sebastião Rogério. Todos os direitos reservados.</p>
          </div>
        </footer>
      </body>
    </html>
